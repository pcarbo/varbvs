...
% is the posterior mean of the coefficients. (Under the fully-factorized
% variational approximation, R = ALPHA.*MU; see VARBVSBIN.)
%
...
function eta = updateeta (X, y, v, Xr, u)
  ...
  % of the intercept given the additive effects.
  a   = 1/sum(u);
