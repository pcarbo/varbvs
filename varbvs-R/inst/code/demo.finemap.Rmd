...
Get the credible SNP sets for the top two SNPs (using the first
hyperparameter setting only).

```{r}
markers1 <- get.credible.set(BF1[,1],credint.prob)
markers2 <- get.credible.set(BF2[,1],credint.prob)
print(c(length(markers1),length(markers2)))
```
