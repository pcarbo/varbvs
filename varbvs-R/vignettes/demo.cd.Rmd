...
data sharing restrictions, so this vignette is for viewing only.
...
## Load the genotype and Crohn's disease data
...
## Summarize the results of fitting the model to the data
