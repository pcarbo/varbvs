...
// sigma, sa, b0 and logodds specify the hyperparameters; n is the number
...
// diagonal of X'*D*X; sa, b0 and logodds specify the hyperparameters;
// n is the number of samples; alpha and mu are the variational
// parameters that will be updated; and Xr is the matrix-vector
// product X*r which will be updated to reflect the changes to alpha
// and mu.
...
// the corresponding entry on the diagonal of X'*D*X; sa, b0 and logodds
